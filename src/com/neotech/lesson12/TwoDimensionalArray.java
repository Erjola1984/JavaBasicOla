...
public class TwoDimensionalArray {
	...
	public static void main(String[] args) {
		...
		//create a 2 dimensional array and set values
		int[] [] nums = {
				{3, 4 ,5 ,6},// row index 0
				{7, 8, 9, 10},//row index1
				{11, 12, 13, 14}// row index2
				};
		...
		//lets print 9
		System.out.println("Lets print 9");
		System.out.println(nums[1][2]);	
		
		//lets find what on row 3; gives error since there is no row with index = 3
